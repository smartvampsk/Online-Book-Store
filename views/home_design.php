<section class="container pt-3 pb-3">
	<?php 
		...
		echo '<p>Welcome back to Online Book Store, <b><i>'.$_SESSION['cust_email'].'</i></b></p>';
	}
	?>
	...
	<div class="row col-md-8">
		<h2 class="">Books</h2>
		<p><a class="btn btn-sm btn-outline-info ml-5 mt-2" href="#">View All Items</a></p>
	</div>
		...
		<div class="col-md-3" id="first"> 
			<div class="card mt-3 m-0">
				...
				<div class="card-body">
					...
					<p class="text-center"><?php echo '<a class="btn btn-success btn-sm" href="#first">Show Detail</a>'; ?> </p>
				</div>
			</div>
		</div>
		<div class="col-md-3"> 
